 ...
 * @author anton
 */
public class PainelTabelaTarefasBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_btBuscar = 11;
    private static final int PROPERTY_campoTextoBusca = 12;
    ...
    private static final int PROPERTY_grupoDataAgFiltr = 45;
    ...
    private static final int PROPERTY_modeloTabela = 68;
    ...
    private static final int PROPERTY_referenciaJan = 84;
    ...
    private static final int PROPERTY_rs = 88;
    private static final int PROPERTY_showing = 89;
    private static final int PROPERTY_size = 90;
    private static final int PROPERTY_tabelaTarefas = 91;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_btBuscar] = new PropertyDescriptor ( "btBuscar", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getBtBuscar", "setBtBuscar" ); // NOI18N
            properties[PROPERTY_campoTextoBusca] = new PropertyDescriptor ( "campoTextoBusca", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getCampoTextoBusca", "setCampoTextoBusca" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_grupoDataAgFiltr] = new PropertyDescriptor ( "grupoDataAgFiltr", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getGrupoDataAgFiltr", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_modeloTabela] = new PropertyDescriptor ( "modeloTabela", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getModeloTabela", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_referenciaJan] = new PropertyDescriptor ( "referenciaJan", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getReferenciaJan", "setReferenciaJan" ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_rs] = new PropertyDescriptor ( "rs", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getRs", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_tabelaTarefas] = new PropertyDescriptor ( "tabelaTarefas", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getTabelaTarefas", null ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( br.com.antoniodiego.gertarefas.telas.principal.paineis.PainelTabelaTarefas.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
