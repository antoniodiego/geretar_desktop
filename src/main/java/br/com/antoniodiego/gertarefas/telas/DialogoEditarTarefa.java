...
public class DialogoEditarTarefa extends javax.swing.JDialog {
    ...
    private void botaoConcluidoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoConcluidoActionPerformed
        ...
        LOG_ARQUIVO.debug("[EDIÇÃO] A tarefa {} de id {} foi editada. Novo comentário: '{}' ,anterior: '{}', novo id perso.: '{}' "+
        ", anterior: '{}'",
                tarefa.getTitulo(), tarefa.getId(), tarefa.getComentario(),comentarioAtual, tarefa.getIdPers(),idPersAtual);
