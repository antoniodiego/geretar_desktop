...
public class DialogoEditarTarefa extends javax.swing.JDialog {
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout
                                                ...
                                                .addGap(164, 164, 164)
                                                .addComponent(btData, javax.swing.GroupLayout.PREFERRED_SIZE, 63,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(campoTitulo, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel4))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(btData)
                                                        .addComponent(btHora, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE))))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(campoPrazo, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel1))
                                .addGap(12, 12, 12)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel6)
                                        .addComponent(campoStatus, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(15, 15, 15)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(rotuloPriori)
                                        .addComponent(campoPrioridade, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 18,
                                        Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(campoHoraAl, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(campoDataAl, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 10,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
    ...
    private void botaoConcluidoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoConcluidoActionPerformed
        ...
        String idCampo = campoId.getText();

        // Verifica se o id tem somente dígitos
        for (int i = 0; i < idCampo.length(); i++) {
            if (!Character.isDigit(idCampo.charAt(i))) {
                JOptionPane.showMessageDialog(this, "Id inválido: " + idCampo, "Erro",
        ...
        Long idComoNumero = Long.parseLong(idCampo);
        ...
        if (tarefaComId != null && !Objects.equals(tarefaComId.getId(), tarefa.getId())) {
            LOG_ARQUIVO.debug("Encontrou tarefa com id personalizado {} salva que não é tarefa atual",
                    idComoNumero);
        ...
        try {
            loggingParaArquivo.loga(
                    "[EDIÇÃO] A tarefa %s de id %d foi editada. Novo comentário: '%s' ,anterior: '%s', novo id perso.: '%d' "
                            +
                            ", anterior: '%d'",
                    tarefa.getTitulo(), tarefa.getId(), tarefa.getComentario(), comentarioAtual, tarefa.getIdPers(),
                    idPersAtual);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        LOG_ARQUIVO.debug(
                "[EDIÇÃO] A tarefa {} de id {} foi editada. Novo comentário: '{}' ,anterior: '{}', novo id perso.: '{}' "
                        +
                        ", anterior: '{}'",
                tarefa.getTitulo(), tarefa.getId(), tarefa.getComentario(), comentarioAtual, tarefa.getIdPers(),
                idPersAtual);
    ...
    public void setTarefa(Tarefa t) {
        ...
        if (prazo != null) {
            ...
            campoPrazo.getModeloDef().setValue(prazo);// Date(prazo.getDayOfMonth(), prazo.getMonthValue(),
                                                      // prazo.getYear());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoEditarTarefa.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
