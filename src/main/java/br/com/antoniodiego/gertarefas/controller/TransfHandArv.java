...
public class TransfHandArv extends TransferHandler {
    ...
    public boolean importData(TransferHandler.TransferSupport t) {
        LOG_CONTR_PRINC.debug("Importando...");
...
//TODO: Implementar colar
        ...
        if (tr.isDataFlavorSupported(Tarefa.TAREFA_FLAVOR)) {
            LOG_CONTR_PRINC.debug("Imp Tarefa fla");
            Tarefa im = null;
            try {
            ...
            LOG_CONTR_PRINC.debug("Recebeu string transf");
            ...
            try {
                ...
                LOG_CONTR_PRINC.debug("Importand XML Tar. Cont: " + strX);
                ...
                // LOG_CONTR_PRINC.debug("Gr ou T lidos: " + gt.size());
                ...
                if (t.isDrop()) {
                    ...
                    LOG_CONTR_PRINC.debug("Adicionando em grupo ins");
...
//                });
    ...
    public boolean canImport(TransferHandler.TransferSupport support) {
        LOG_CONTR_PRINC.debug("pode imp?");
    ...
    protected void exportDone(JComponent source, Transferable data, int action) {
        if (action == MOVE) {
            LOG_CONTR_PRINC.debug("Export mov con");
...
//                            } else {
    ...
    protected Transferable createTransferable(JComponent c) {
        LOG_CONTR_PRINC.traceEntry("Criando o transferable. Comp {}", c);
        ...
        try {
            ...
            Logger.getLogger(TransfHandArv.class.getName()).log(Level.SEVERE, null, ex);
        }
